...
namespace EZRoomGen
{
    ...
    public class RoomGeneratorEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(gridHeightProp, new GUIContent("Grid Height"));
            ...
            EditorGUILayout.PropertyField(uvScaleProp);
            ...
            EditorGUILayout.PropertyField(roomSpacingProp);
            EditorGUILayout.PropertyField(corridorSpacingProp);
            ...
            if (realtimeGenerationProp.boolValue && (paramsChanged || materialsChanged))
            {
                generator.GenerateRoom();
            }
        }
